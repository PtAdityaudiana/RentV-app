...
Route::prefix('admin')->middleware('adminAuth')->group(function () {
    ...
    Route::post('/bookings/{id}/return', [AdminController::class, 'bookingReturn'])->name('admin.bookings.return');
    Route::post('/bookings/{id}/late', [AdminController::class, 'bookingLate'])->name('admin.bookings.late');
